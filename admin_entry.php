...
//	echo "<div id='edit-window-delete-button' style='right: 20px;'><a href='/e/".$entry_confirmed['entry_id']."/delete/'>Delete</a></div>";
	echo "<div id='edit-window-delete-button' style='right: 160px;'><a href='/".$entry_confirmed['entry_id']."/delete/'>Delete</a></div>";
	echo "<div id='edit-window-open-button'><a href='/e/".$entry_confirmed['entry_id']."/' target='_blank'>Open entry</a></div>";
else:
